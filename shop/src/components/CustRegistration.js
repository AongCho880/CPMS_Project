    ...
    return (
        <Fragment>
            <div className="container-fluid align-item-center justify-content-center">
                <div className="row">
                    <div className="col-md-10 offset-md-1"> {/* Adjusted column width */}
                        ...
                        <form onSubmit={onSubmitForm}>
                                ...
                                <div className="row">
                                    <div className="col-md-6"> {/* Adjusted column width */}
                                        ...
                                        <div className="d-flex flex-column align-items-center">
                                            ...
                                            {!frontCameraActive ? (
                                                <button className="btn btn-secondary" onClick={startFrontCamera}>Take Front NID</button>
                                            ) : (
                                                <Fragment>
                                    ...
                                    <div className="col-md-6"> {/* Adjusted column width */}
                                        ...
                                        <div className="d-flex flex-column align-items-center">
                                            ...
                                            {!backCameraActive ? (
                                                <button className="btn btn-secondary" onClick={startBackCamera}>Take Back NID</button>
                                            ) : (
                                                <Fragment>
                            ...
                            <div className="mb-3">
                                ...
                                <div className="d-flex flex-column align-items-center">
                                    ...
                                    {!selfieCameraActive ? (
                                        <button className="btn btn-secondary" onClick={startSelfieCamera}>Take Profile photo</button>
                                    ) : (
                                        <Fragment>
                                            ...
                                            <div className="d-flex flex-column align-items-center mt-3">
                                                ...
                                                <button className="btn btn-primary mt-2" onClick={captureSelfiePhoto}>Capture Profile Photo</button>
                                            </div>
                                        </Fragment>
                                    )}
                                </div>
